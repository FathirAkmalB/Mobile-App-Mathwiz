...
class ListSubjectExam extends StatefulWidget {
  const ListSubjectExam({super.key});

  @override
  State<ListSubjectExam> createState() => _ListSubjectExamState();
}

class _ListSubjectExamState extends State<ListSubjectExam> {
  String _searchQuery = '';
  int _currentIndex = 2;
...
//  Mengambil data Subjects
  Future<Map<String, dynamic>> fetchSubjects({String? filter}) async {
    ...
    final response =
        await API().getRequest(route: '/getAllDataExam/$studentId');
                                ...
                                if (totalSubject < 1) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      final examAttempted =
                                          subject['total_attempted_exam'];
                                      final totalExam = subject['total_exam'];
                                      final coverBook = subject['cover'];
                                      double decimal =
                                          examAttempted / totalExam;
